        ...
        <div id="sidebar-left" class="span2">
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    ...
                    <li><a href="{{URL::to ('/dashboard/blog') }}"><i class="fas fa-blog"></i><span class="hidden-tablet"> Blog</span></a></li>
                    <li><a href="{{URL::to ('/dashboard/blog/add') }}"><i class="fas fa-plus"></i><span class="hidden-tablet"> Add Post  </span></a></li>
                </ul>
            </div>
        </div>
        <!-- end: Main Menu -->
