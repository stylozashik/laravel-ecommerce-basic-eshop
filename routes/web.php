...
// Blog frontend
Route::get('/blog','BlogController@home_view');

// Blog backend
Route::get('/dashboard/blog','BlogController@index');
Route::get('/dashboard/blog/add','BlogController@create');
Route::post('/dashboard/blog/add','BlogController@store');
